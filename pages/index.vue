  ...
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm:items-center sm:pt-0">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <a class="flex justify-center pt-8 sm:pt-0" href="https://nuxtjs.org" target="_blank">
        <svg width="218" height="45" viewBox="0 0 159 30" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path
            ...
            fill="#003543"/>
          <path d="M107.64 29.7344L103.784 24.2342L99.9291 29.7344H95.6492L101.596 21.1242L96.1074 13.2339H100.485L103.784 17.9821L107.051 13.2339H111.461L105.94 21.1242L111.886 29.7344H107.64Z"
                fill="#003543"/>
          <path
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold" id="step1">
      ...
      <div class="flex justify-center pt-4 space-x-2" id="step2">
    ...
    introJsFunction() {
      setTimeout(function () {
        ...
        intro.setOptions({
          steps: [
            {
              intro: "Welcome to your Nuxt Application",
            },
            {
              element: '#step1',
              intro: "Intro js text message id #step1",
            },
            {
              element: '#step2',
              intro: "Intro js text message id #step2 message text"
            },
